...
def macro_debate_node(state: BerkshireState):
    """
    LLM-powered explainer/debater for macroeconomics.
...
{{"explanation":"<3-6 concise sentences>", "claims_conceded":["<opponent claim accepted>"], "claims_disputed":["<opponent claim disputed>"], "weighting_statement":"<which factor dominated and why>", "horizon_alignment_note":"<why this macroeconomic stance fits selected horizon>", "dialogue_response":"<1-2 natural-language sentences responding directly to opponent>", "final_position":{{"rating":"<strong_buy|buy|hold|sell|strong_sell>", "confidence":<0.0-1.0>}}}}
"""
